...
pipeline {
    ...
    stages  {
        ...
        stage("build-image") {
            ...
            steps {
                sh 'docker build . -t enablementprojects/tmem-user:latest'
            }
        }
        ...
        stage("push-image") {
            ...
            steps {
                sh 'docker push enablementprojects/tmem-user'
            }
 	    }
        ...
        stage("deploy-image") {
            ...
            steps {
                sh 'kubectl rollout restart deployment/tmem-user  --namespace=tmem'
            }
         }
    }
